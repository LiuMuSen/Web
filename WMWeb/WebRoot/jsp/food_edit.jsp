...
<body>
	<form id="itemsForm" action="${pageContext.request.contextPath }/items/saveOrUpdate.do" method="post">
		...
		<tr>
			<td width="10%">菜品名称:</td>
			<td><input type="text" name="itemsName" value="${item.itemsName }"/></td>
		</tr>
		<tr>
			<td width="10%">菜品价格:</td>
			<td><input type="text" name="itemsPrice" value="${item.itemsPrice }"/></td>
		</tr>
		<tr>
			<td width="10%">菜品图片:</td>
			<td>
		...
		<tr>
			<td width="10%">菜品简介:</td>
			<td><textarea rows="9" cols="100" name="itemsContent" id="items_content">${item.itemsContent }</textarea></td>
		</tr>
		<tr>
