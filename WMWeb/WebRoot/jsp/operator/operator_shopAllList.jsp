				...
				<TBODY>
					...
					<tr><td>
						<table cellpadding="0" cellspacing="0" border="0" width="100%">
							<tr>
								<td height="22" align="center" bgColor="#f5fafe" class="ta_01" width="15%">商店名称:</td>
								<td class="ta_01" bgColor="#ffffff"><input type="text" name="userPhone" size="15" Class="bg"/></td>
								<td height="22" align="center" bgColor="#f5fafe" class="ta_01" width="15%">店主姓名:</td>
								<td class="ta_01" bgColor="#ffffff"><input type="text" name="userName" size="15" Class="bg"/></td>
							</tr>
							<tr><td height="22" align="center" bgColor="#f5fafe" class="ta_01" width="15%">商店电话:</td>
								<td class="ta_01" bgColor="#ffffff"><input type="text" name="userName" size="15" Class="bg"/></td>
							</tr>
					...
					<tr><td class="ta_01" align="center" bgColor="#f5fafe">
						<table cellspacing="0" cellpadding="1" rules="all" bordercolor="gray" border="1" id="DataGrid1"
							...
							<tr style="FONT-WEIGHT: bold; FONT-SIZE: 12pt; HEIGHT: 25px; BACKGROUND-COLOR:rgb(70,141,188)">
								<td align="center" width="10%">商店logon</td>
								<td align="center" width="5%">商店编号</td>
								<td align="center" width="10%">商店名称</td>
								<td align="center" width="10%">店主姓名</td>
								<td align="center" width="10%">商店电话</td>
								<td align="center" width="10%">商店类型</td>
								<td align="center" width="25%">商店简介</td>
							</tr>
					...
					<tr><td><!-- 分页 -->
						<div class="pagination"><ul>
							<li class="disablepage"><a href="${pageContext.request.contextPath }/operator/pageOfshop.do?currentPage=${pageOfApplys.currentPage-1<1?1:pageOfApplys.currentPage-1}">&lt;&lt;上一页</a></li>
							<li>第${pageOfApplys.currentPage }页/共${pageOfApplys.totalPage }页</li>
							<li class="nextPage"><a href="${pageContext.request.contextPath }/operator/pageOfshop.do?cu
